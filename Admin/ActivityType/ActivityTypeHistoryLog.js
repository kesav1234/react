...
class ActivityTypeHistoryLog extends Component {
    constructor(props){
        super(props);
        this.state = {
            tableColumns:[],
    ...
    renderList(list) {
        ...
        _.map(list, (item, index) => {
            ...
            item['itemChanged'] = item.itemChanged === 'Category Id'?'Activity Category':item.itemChanged;
    ...
    render(){
        ...
        return(
            <div>
                {this.props.activityTypeHistoryAvailable?this.renderList(this.props.activityTypeHistoryLog):null}
            </div>
        )
    }
}
...
const mapStateToProps = (state)=>{
    return {
        ...
        activityTypeHistoryAvailable: state.adminData.activityTypeHistortAvailable
    }  
}

export default connect(mapStateToProps,null)(ActivityTypeHistoryLog);